...
AFRAME.registerComponent("markerhandler", {
  ...
  tick: function () {
    if (elementsArray.length > 1) {
      ...
      if (length === 3) {
        var marker1 = document.querySelector(`#marker-${elementArray[0].barcode_value}`);
        var marker2 = document.querySelector(`#marker-${elementArray[1].barcode_value}`);
